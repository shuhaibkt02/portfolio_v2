...
const DOMAINS: DomainNode[] = [
    {
        ...
        label: "Shuhaib KT",
        shortLabel: "Core",
        tagline: "Senior Flutter Developer",
        description: "2+ years building production-grade mobile applications. Specialized in offline-first ERP systems, native Android integrations, and complex state management architectures.",
        capabilities: [
